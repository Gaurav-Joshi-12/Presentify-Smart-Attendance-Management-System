...
function Modal({
  ...
  if (!open) return null;
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex p-4 sm:p-6 bg-black/60 backdrop-blur-sm overflow-y-auto", onClick: onClose, children: /* @__PURE__ */ jsxs("div", { className: "m-auto glass-strong flex flex-col rounded-2xl w-full max-w-2xl overflow-hidden", onClick: (e) => e.stopPropagation(), children: [
